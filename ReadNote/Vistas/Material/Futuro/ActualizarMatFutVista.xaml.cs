...
namespace ReadNote.Vistas.Material.Futuro
{
    ...
    public partial class ActualizarMatFutVista : ContentPage
    {
        ...
        public ActualizarMatFutVista(int id, string nombre, string autor, string descripcion, string categoria, string numPaginas, bool estado, string nivelLector, DateTime fechaCreacion, string tipoMaterial)
        {
            InitializeComponent();
